#!/bin/bash
# Verify the legacy SQLite fixture setup.
# The cbi-dashboard runtime is PostgreSQL-only.

DB_FILE="cylinder_seal.db"

echo "Verifying SQLite fixture setup..."
echo "Note: this fixture is not a supported cbi-dashboard runtime database."
echo ""
...
echo "SQLite fixture is queryable."
echo ""
echo "For the PostgreSQL dashboard runtime:"
